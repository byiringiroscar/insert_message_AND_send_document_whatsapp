...
path_file = [f for f in os.listdir('.') if os.path.isfile(f) and f.endswith('.csv') or f.endswith('.pdf') or f.endswith('.xlsx') or f.endswith('.xls')]
...
if path_file:
    ...
    print(" ====================no matched file availabe ====================")
